...
export default class Main extends Component {
    ...
    render() {
        ...
        return (
            <>
            <h1 className="hello">Welcome to Expensify! </h1>
            <p className="mello">Keep track of your expenses at one place</p>
            <p className="mello">Acessible At Anytime,Anywhere</p>
                {!this.state.user ? (
                    <div className="mainBlock">
                      {form}
                      {
...
//             Not Registered? <button className="linkBtn">
// Create an account
//             </button>
//             </span>
//         </div>
